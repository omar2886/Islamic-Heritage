...
## Funcional (V3)
- [ ] Builder V3 renderiza secciones y Personas.
...
## A11y
- [ ] *Skip link* visible en foco; lleva al contenido (home/builder/results V3).
...
- [ ] El zip **excluye** legacy (`public/js/ui/`, vistas builder/results/genealogy antiguas, `public/tools/`).
