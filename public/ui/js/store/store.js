...
function makeDefaultBuilder(){
  return {
    ...
    treeUi: {
      ...
      modal: null,
      wizardPendingImport: false, // NUEVO: handshake wizard -> builder
      wizardPendingFrom: null,    // NUEVO: "wizard" | null (traza)
    },
...
function makePersistSnapshot(state){
  ...
  const builder = {
    ...builderRaw,
    // no persistimos modales, pero SI persistimos wizardPendingImport para que el salto wizard->builder sea determinista
...
function sanitizeState(input){
  ...
  if (builderRaw.treeUi && typeof builderRaw.treeUi === "object"){
    builder.treeUi = {
      ...
      modal: null,
      wizardPendingImport: builderRaw.treeUi.wizardPendingImport === true,
      wizardPendingFrom: typeof builderRaw.treeUi.wizardPendingFrom === "string" ? builderRaw.treeUi.wizardPendingFrom : null,
    };
  }
