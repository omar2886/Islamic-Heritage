...
define('DB_HOST', heritage_env('DB_HOST', 'localhost'));
define('DB_NAME', heritage_env('DB_NAME', 'heritage'));
define('DB_USER', heritage_env('DB_USER', 'root'));
define('DB_PASS', heritage_env('DB_PASS', ''));

// La BASE_URL debe apuntar al directorio que contiene "public"
define('BASE_URL', heritage_env('BASE_URL', ''));
